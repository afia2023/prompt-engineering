...
# Save SVG
plt.savefig("publication_year.svg", format="svg", bbox_inches="tight")
plt.savefig("publication_year.pdf", format="pdf", bbox_inches="tight")
plt.savefig("publication_year.png", format="png", dpi=600, bbox_inches="tight")
